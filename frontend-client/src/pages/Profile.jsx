        ...
        <div className="min-h-screen bg-gray-100">
            ...
            <div className="max-w-7xl mx-auto pt-24">
                ...
                <div className="bg-white p-4 rounded shadow mb-6">
                    ...
                    <button onClick={logout} className="bg-red-500 text-white px-3 py-1 rounded cursor-pointer">
                        Logout
                    </button>
                </div>
                        ...
                        <div className="space-y-4">
                            {enquiries.map((e) => (
                                <div key={e._id} className="bg-white p-4 rounded shadow">
                                    <h3 className="font-semibold">{e.property?.name}</h3>

                                    <p>{e.property?.location}</p>

                                    <p className="text-gray-600 text-sm mt-1">Message: {e.message}</p>

                                    <p className="mt-2 text-sm">
                                        Status: <span className="text-blue-600">{e.status}</span>
                                    </p>
