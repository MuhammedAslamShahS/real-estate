...
const PropertyListCard = () => {
    ...
    if (!properties.length)
        return <div className="min-h-screen flex items-center justify-center">No properties found.</div>;
                    ...
                    <div key={p._id} className="bg-white rounded-xl overflow-hidden">
                        ...
                        <div className="p-4">
                            ...
                            <div className="flex gap-2 mt-3 text-sm">
                                <span className="bg-gray-200 px-2 py-1 rounded capitalize">{p.category}</span>
                                <span className="bg-blue-100 text-blue-700 px-2 py-1 rounded capitalize">{p.type}</span>
                            </div>
